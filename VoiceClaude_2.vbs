...
If pythonw = "" Then
    MsgBox "Python не найден. Запустите install.bat.", 16, "VoiceClaude #2"
    WScript.Quit
End If

Dim psCmd
psCmd = "Start-Process '" & pythonw & "' -ArgumentList '" & dir & "\main.py --instance 2 --config config_2.json' -Verb RunAs"
