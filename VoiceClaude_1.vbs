...
Const CONFIG_FILE   = "config_1.json"
' ─────────────────────────────────────────────────────────────────────────────
...
If pythonw = "" Then
    MsgBox "Python не найден. Запустите install.bat.", 16, "VoiceClaude #1"
    WScript.Quit
End If

Dim psCmd
psCmd = "Start-Process '" & pythonw & "' -ArgumentList '" & dir & "\main.py --instance 1 --config config_1.json' -Verb RunAs"
